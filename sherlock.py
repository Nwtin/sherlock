...
def gen_markup():
    markup = InlineKeyboardMarkup()
    markup.row_width = 1
    markup.add(InlineKeyboardButton("➕ADICIONE-ME A UM GRUPO➕", url="https://t.me/sherlock_rbot?startgroup=start")
        ,InlineKeyboardButton("🔍Menu de Consultas🔍", callback_data="cb_yes")
        ,InlineKeyboardButton("🛠Checkers VIP", callback_data="cb_no")
        ,InlineKeyboardButton("☸Geradores", callback_data="cb_cnpj")
        ,InlineKeyboardButton("💎Planos💎", callback_data="cb_nome")
        ,InlineKeyboardButton("Grupo Oficial Do Bot", url="https://t.me/consultassss")
    )
    return markup
